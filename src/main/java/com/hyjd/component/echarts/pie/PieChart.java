...
@FacesComponent(namespace = "http://www.nkstar.com/component/echarts", createTag = true, tagName = "pieChart", value = PieChart.COMPONENT_TYPE)
public class PieChart extends UIChart {
	// 用于xml配置和render
	public static final String COMPONENT_FAMILY = "com.nkstar.component.echarts";
	public static final String COMPONENT_TYPE = "com.nkstar.component.echarts.pie.PieChart";
	static final String DEFAULT_RENDERER = "com.nkstar.component.echarts.pie.PieChartRenderer";
